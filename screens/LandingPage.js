    ...
    >
      <View style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={{ paddingBottom: 120 }}>
            ...
            <>
              ...
              <View style={styles.sideMenu}>
                ...
                <View style={styles.menuGroup}>
                  ...
                  <TouchableOpacity
                    onPress={() => handleCategoryPress("tshirts")}
                  >
                    <Text style={styles.subMenuItem}>T-Shirts</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    onPress={() => handleCategoryPress("longsleeve")}
                  >
                ...
                <View style={styles.menuGroup}>
                  ...
                  <TouchableOpacity
                    onPress={() => handleCategoryPress("shorts")}
                  >
          ...
          <TouchableOpacity
            onPress={() =>
              navigation.navigate("CategoryProducts", { categoryKey: "latest" })
            }
          >
        ...
        <View style={styles.footerNav}>
          {["Home", "Cart", "Orders", "Profile"].map((tab) => {
            ...
            return (
              <TouchableWithoutFeedback
                key={tab}
                onPress={() => handleTabPress(tab, navigateTo)}
              >
                <Animated.View
                  style={{
