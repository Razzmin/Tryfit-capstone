...
export default function ProductDetail() {
  ...
  const getTotalStock = () => {
    return Object.values(safeStock || {}).reduce(
  ...
  const saveCartItem = async () => {
    ...
    if (modalQuantity > stockAvailable) {
      Alert.alert(
        "Error",
        `Only ${stockAvailable} item(s) available for this size.`,
        [
          {
            text: "OK",
            onPress: () => setIsSaving(false),
  ...
  const handleTryOn = () => {
    ...
    if (!product?.arUrl) {
      Alert.alert(
        "AR not available",
        "Sorry, this product doesn’t have an AR try-on link yet."
      );
    ...
    <>
          ...
          >
            <ProductContainer style={{ flex: 1 }}>
              ...
              <Content style={{ paddingHorizontal: 21 }}>
                ...
                >
                  <ProductPrice style={{ lineHeight: 40, fontSize: 32 }}>
                    ₱{product.price}
                  </ProductPrice>
                </View>
                  ...
                  {reviews
                    ...
                    .map((item) => (
                      <ReviewItems key={item.id}>
                        <Avatar
                          style={{
                            backgroundColor: item.avatarColor || "#9747FF",
                          }}
                        >
                          <AvatarText>
      ...
      <NavBar>
        ...
        <AddCartBtn onPress={handleTryOn} disabled={isTryOnProcessing}>
          <AddCartText>
            {isTryOnProcessing ? "Processing..." : "Try-on"}
          </AddCartText>
        </AddCartBtn>
      </NavBar>
              ...
              >
                ...
                >
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    <Text
                      style={{ fontSize: 16, color: "#9747FF", marginTop: 4 }}
                    >
                ...
                <View style={{ width: "100%", marginBottom: 10 }}>
                  <Text
                    style={{ fontSize: 15, marginBottom: 6, fontWeight: "600" }}
                  >
                    Quantity:
                  </Text>
                  <View
                  ...
                  >
                    ...
                    >
                      ...
                      <TouchableOpacity
                        ...
                        style={{
                          backgroundColor:
                            modalQuantity >= getSizeStock(selectedSize)
                              ? "#ddd"
                              : "#9747FF",
                          width: 35,
                          height: 35,
